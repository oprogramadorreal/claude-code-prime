...
Read `$CLAUDE_PLUGIN_ROOT/skills/init/references/constraint-doc-loading.md` for the full doc loading algorithm (single project and monorepo layouts, scoping rules).
