...
- `.claude/agents/code-simplifier.md` (legacy — installed by previous optimus versions)
- `.claude/agents/test-guardian.md` (legacy — installed by previous optimus versions)
...
|---|---|
| `.claude/agents/code-simplifier.md` | `$CLAUDE_PLUGIN_ROOT/agents/code-simplifier.md` |
| `.claude/agents/test-guardian.md` | `$CLAUDE_PLUGIN_ROOT/agents/test-guardian.md` |
