...
Launch 2 `general-purpose` Agent tool calls simultaneously — one per agent.

Read the agent prompt files from `$CLAUDE_PLUGIN_ROOT/skills/tdd/references/agents/`:
- Agent A: `code-simplifier.md`
- Agent B: `test-guardian.md`
