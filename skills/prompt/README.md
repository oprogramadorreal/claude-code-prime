...
- **12 prompt templates** — auto-selected architecture (RTF, CO-STAR, RISEN, ReAct, Visual Descriptor, etc.) based on task type and target tool
- **35 diagnostic patterns** — detects and fixes credit-killing patterns (vague verbs, missing scope, no stop conditions, wrong template for tool)
...
| `references/templates.md` | 12 prompt architecture templates |
| `references/diagnostic-patterns.md` | 35 credit-killing pattern checklist |
