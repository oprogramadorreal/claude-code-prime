...
Launch 1 `general-purpose` Agent tool call using the Agent 1 prompt from the agent-1-codebase-detection.md file, prepended with the reference file contents above.
