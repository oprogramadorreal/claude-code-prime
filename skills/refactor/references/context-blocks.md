...
Templates used by the refactor SKILL.md to inject context into agent prompts. These are NOT agent-level content — they are composition templates applied by the orchestrator.
